...
{
    /// <summary>
    /// Implementation of κ-Curves system
    /// </summary>
    public static class KCurves
    {
        ...
        */
        ...
        /// <summary>
        /// Wrapper of Vector3[] for Bezier control-points. c_{i,j} can be accessed by indexer [i,j].
        /// </summary>
        ...
        /// Please renew the instance when the number of user's control-points has changed.
        /// </summary>
        public sealed class CalcSpace
        {
            /// <summary>
            /// The number of user's control-points
            /// </summary>
        ...
        public sealed class PlotSpace
        {
            ...
            public PlotSpace(int n, int stepPerSegment, bool isLoop)
            {
                ...
                if (n < 3)
                    ...
                    Result = new Vector3[(isLoop ? n : (n - 2)) * stepPerSegment + 1];
            }
        }
        ...
        public static BezierControls CalcBezierControls(Vector3[] points, CalcSpace space, int iteration, bool isLoop)
        {
        ...
        /// </summary>
        public static Vector3 CalcPlotSingle(Vector3 c0, Vector3 c1, Vector3 c2, float t)
        {
            var s = 1 - t;
        ...
        public static Vector3[] CalcPlots(Vector3[] points, CalcSpace calcSpace, PlotSpace plotSpace, int iteration, int stepPerSegment, bool isLoop)
        {
            //ベジェ制御点を計算
        ...
        public static Vector3[] CalcPlots(BezierControls cs, PlotSpace space, int stepPerSegment, bool isLoop)
        {
            //各セグメントについて、指定されたステップ数で分割した点を計算
            int offset, k;
        ...
        public static bool IsOnBezierCurve(Vector3[,] cs, Vector3 x, float range, out float distance)
        {
            distance = -1f;
        ...
        public static bool IsOnBezierCurve(Vector3 c0, Vector3 c1, Vector3 c2, Vector3 x, float range, out float distance)
        {
        ...
        public static void SameLengthPlots(Vector3[] curve, List<Vector3> separated, float segmentSize)
        {
            separated.Clear();
            if (curve.Length == 0)
            {
        ...
        /// </summary>
        public static float CurveLength(Vector3[] curve)
        {
            var ret = 0f;
            for (int i = 0; i < curve.Length - 1; i++)
            {
